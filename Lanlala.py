...
fruits = [("apple", "banana", "cherry", "date", "elderberry", "fig", "grape", "mango", "nectarine", "orange",
 "papaya", "quince", "raspberry", "strawberry", "tangerine", "ugli fruit", "vanilla bean", "watermelon", 
    "xigua", "yellow passion fruit", "zucchini", "kiwi", "lemon", "lime", "blueberry", "blackberry", "cantaloupe", 
        "honeydew", "kumquat", "mandarin", "olive", "persimmon", "pomegranate", "rhubarb", "starfruit", "tomato", 
        "ugli fruit", "vanilla bean", "watermelon", "xigua", "yellow passion fruit", "zucchini", "kiwi", "lemon", 
           "lime", "blueberry", "blackberry", "cantaloupe", "honeydew", "jackfruit", "kumquat", "lychee", "mandarin", 
         "olive", "persimmon", "pomegranate", "rhubarb", "starfruit", "tomato", "ugli fruit", "vanilla bean", 
           "watermelon", "xigua", "yellow passion fruit", "zucchini", "kiwi", "lemon", "lime", "blueberry", "blackberry", 
        "cantaloupe", "honeydew", "jackfruit", "kumquat", "lychee", "mandarin", "olive", "persimmon", "pomegranate",
            "rhubarb", "starfruit", "tomato", "ugli fruit", "vanilla bean", "watermelon", "xigua", "yellow passion fruit",
            "zucchini", "kiwi", "lemon", "lime", "blueberry", "blackberry", "cantaloupe", "honeydew", "jackfruit",
                "kumquat", "lychee", "mandarin", "olive", "persimmon", "pomegranate", "rhubarb", "starfruit", "tomato",
                  "ugli fruit", "vanilla bean", "watermelon", "xigua", "yellow passion fruit", "zucchini", "kiwi",
                    "lemon", "lime", "blueberry", "blackberry", "cantaloupe", "honeydew", "jackfruit", "kumquat", 
                    "lychee", "mandarin", "olive", "persimmon", "pomegranate", "rhubarb", "starfruit", "tomato",
                      "ugli fruit", "vanilla bean", "watermelon", "xigua", "yellow passion fruit", "zucchini", "kiwi", 
                      "lemon", "lime", "blueberry", "blackberry", "cantaloupe", "honeydew", "jackfruit", "kumquat",
                        "lychee", "mandarin", "olive", "persimmon", "pomegranate", "rhubarb", "starfruit", "tomato", 
                        "ugli fruit", "vanilla bean", "watermelon", "xigua", "yellow passion fruit", "zucchini", "kiwi",
                          ...
                          "lemon", "lime", "blueberry", "blackberry", "cantaloupe", "honeydew", "jackfruit", "kumquat", 
                          "lychee", "mandarin", "olive", "persimmon", "pomegranate", "rhubarb", "starfruit", "tomato")]
four_word_fruit = [("date", "lime", "Kiwi", )]
five_words_fruit = [("apple", "lemon", "olive", "mango", "xigua",
"lychee")]
...
#the while loop will contiune the guessign game till the user it right 

def guessing_game():
    while True:
        Guess = input("Guess the fruit (or type 'skip to skip'): ")
        if Guess.lower() == f_word:
            print(f"The correct word was {f_word.upper()}")
            break
